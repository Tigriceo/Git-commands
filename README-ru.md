...
### [Книга по командам гитхаба и онлайн документация](https://git-scm.com/book/ru/v2).
...
[Как использовать консоль Bash в Windows, основные команды](https://github.com/Tigriceo/Git-commands/blob/main/GIT-BASH-ru.md).  
