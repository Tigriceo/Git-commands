...
Файли та директорії, які не потрібно включати до репозиторій, вказуються у файлі `.gitignore`. Зазвичай це встановлювані залежності (`node_modules/`, `bower_components/`), готове складання `build/` або `dist/` і подібні, створювані під час встановлення або запуску. Кожен файл або директорія вказуються з нового рядка, [можливе використання шаблонів](http://git-scm.com/book/ua/v2/%D0%9E%D1%81%D0%BD%D0%BE%D0% B2%D1%8B-Git-%D0%97%D0%B0%D0%BF%D0%B8%D1%81%D1%8C-%D0%B8%D0%B7%D0%BC%D0%B5% D0%BD%D0%B5%D0%BD%D0%B8%D0%B9-%D0%B2-%D1%80%D0%B5%D0%BF%D0%BE%D0%B7%D0%B8% D1%82%D0%BE%D1%80%D0%B8%D0%B9#Ігнорування файлів).


### Консоль

[Як використовувати консоль Bash у Windows, основні команди](https://github.com/Tigriceo/Git-commands/blob/main/GIT-BASH.md).
